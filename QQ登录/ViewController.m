...
- (void)CreateUI {
    ...
    button.frame = CGRectMake(20, 60, self.view.frame.size.width - 40, 40);
    ...
    [button addTarget:self action:@selector(QQButtonMethod:) forControlEvents:UIControlEventTouchUpInside];
    [self.view addSubview:button];
}

- (void)QQButtonMethod:(UIButton *)button {
...
- (void)SetupAlertController {
    ...
    UIAlertController *vc = [UIAlertController alertControllerWithTitle:@"温馨提示" message:@"未安装QQ，无法使用QQ登录" preferredStyle:UIAlertControllerStyleAlert];
